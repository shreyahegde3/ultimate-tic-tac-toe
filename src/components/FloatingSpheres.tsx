...
const FloatingSpheres: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 overflow-hidden z-0">
      ...
      <Sphere size="110px" color="#F97316" top="80%" left="85%" delay="0.8s" opacity="0.4" duration="11s" />
      <Sphere size="80px" color="#33C3F0" top="25%" left="50%" delay="1.5s" opacity="0.6" duration="9s" />
      <Sphere size="100px" color="#8B5CF6" top="60%" left="40%" delay="2s" opacity="0.45" duration="13s" />
      <Sphere size="75px" color="#F97316" top="10%" left="70%" delay="1s" opacity="0.5" duration="15s" />
      <Sphere size="120px" color="#3f3f50" top="85%" left="5%" delay="1.7s" opacity="0.25" duration="16s" />
      <Sphere size="95px" color="#6366f1" top="5%" left="30%" delay="0.3s" opacity="0.35" duration="14s" />
    </div>
  );
};
